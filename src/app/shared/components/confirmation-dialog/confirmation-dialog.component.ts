...
@Component({
  ...
  template: `
    ...
    <mat-dialog-actions>
      ...
      <button mat-button [mat-dialog-close]="action">Ok</button>
    </mat-dialog-actions>
  `,
  styles: ``,
...
export class ConfirmationDialogComponent {
  readonly #data = inject<{ title: string; content: string; action: 'toggleValidation' | 'deleteRecord' }>(MAT_DIALOG_DATA);
